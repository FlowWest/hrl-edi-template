...
Helper code is included in `make-eml.R`

- categorical variable definitions (as needed)
- intellectual rights (automatically generated based on CCBY license)

5. Make EML

Fill in the information needed at the top of `data-raw/make-eml.R` then run
this script to generate the EML document needed to publish. 
